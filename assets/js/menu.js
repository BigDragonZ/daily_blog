    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: '02 现金流量表专项', link: 'pages/accounting/managerial-accounting/02-cash-flow-statement.html' },
          { title: '03 财务报表分析 I：趋势与共同尺寸', link: 'pages/accounting/managerial-accounting/03-trend-common-size.html' },
          { title: '04 财务报表分析 II：比率分析 PALMS', link: 'pages/accounting/managerial-accounting/04-ratio-analysis-palms.html' },
          { title: '05 产品成本基础：COGM/COGS 与成本流转', link: 'pages/accounting/managerial-accounting/05-product-costs-cogm-cogs.html' },
          { title: '06 分批成本法', link: 'pages/accounting/managerial-accounting/06-job-order-costing.html' },
          { title: '07 分步成本法与约当产量', link: 'pages/accounting/managerial-accounting/07-process-costing.html' },
          { title: '08 制造费用分配：全厂费率 vs ABC', link: 'pages/accounting/managerial-accounting/08-overhead-abc.html' },
          { title: '09 成本性态与成本估计', link: 'pages/accounting/managerial-accounting/09-cost-estimation.html' },
          { title: '10 本量利分析 CVP', link: 'pages/accounting/managerial-accounting/10-cvp-analysis.html' },
          { title: '11 变动成本法 vs 吸收成本法', link: 'pages/accounting/managerial-accounting/11-variable-vs-absorption.html' },
          { title: '12 预算编制：销售→生产→现金', link: 'pages/accounting/managerial-accounting/12-budgeting.html' },
          { title: '13 标准成本与差异分析', link: 'pages/accounting/managerial-accounting/13-standard-costing-variance.html' },
          { title: '14 资本预算：回收期、NPV、IRR、PI', link: 'pages/accounting/managerial-accounting/14-capital-budgeting.html' },
          { title: '15 相关成本与短期经营决策', link: 'pages/accounting/managerial-accounting/15-relevant-costing.html' },
        ],
      },
    ],
  },
